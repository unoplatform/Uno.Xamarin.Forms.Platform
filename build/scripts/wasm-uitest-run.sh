...
mono $BUILD_SOURCESDIRECTORY/build/NUnit.ConsoleRunner.3.10.0/tools/nunit3-console.exe --trace=Verbose --inprocess --agents=1 --workers=1 $BUILD_SOURCESDIRECTORY/Xamarin.Forms.Core.UITests.Wasm/bin/Release/net47/Sample.UITests.dll
